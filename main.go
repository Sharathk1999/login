...
func login(w http.ResponseWriter, r *http.Request) {
	...
	details := Detail{"Login to Continue", ""}
	if errMsg != "" {
		details.ErrMsg = "Incorrect username or password"
	}
	err = t.ExecuteTemplate(w, fileName, details)
	if err != nil {
...
func handler(w http.ResponseWriter, r *http.Request) {
	...
	case "/home":
		...
		t.ExecuteTemplate(w, fileName, "Home Sweet Home...")
		if err != nil {
			fmt.Println(err)
			return
		}
